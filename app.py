...
conn = psycopg2.connect('postgresql://aman:Amantesting1@free-tier8.aws-ap-southeast-1.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full&sslrootcert=root.crt&options=--cluster%3Dalive-camel-367')
